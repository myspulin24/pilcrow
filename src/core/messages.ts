...
export const t = {
  ...
  rail: {
    label: 'Poznámky a skupiny',
    hide: 'Skrýt panel s poznámkami',
    hideHint: 'Skrýt tento panel (Ctrl + \\)',
    show: 'Zobrazit panel s poznámkami',
    showHint: 'Zobrazit poznámky a skupiny (Ctrl + \\)',
    resize: 'Šířka panelu s poznámkami',
  ...
  workspace: {
    ...
    /** Do úzkého panelu se celý popis nevejde; význam nese `search`. */
    searchShort: 'Hledat',
